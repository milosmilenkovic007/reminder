<html>
    <head>
        ...
        <title>SMS Reminder System - @milos('title', 'reminders')</title>
    </head>
    <body>
        <nav class="navbar navbar-default">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">SMS Reminder</a>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="{{ route('appointment.index') }}">Home</a></li>
                    <li><a href="{{ route('appointment.create') }}">New Reminder</a></li>
                </ul>
            </div>
        </nav>
        <div class="container">
        ...
        <footer class="container">
            By Milos Milenkovic
            <a href="https://milosmilenkovic.ml">@milos</a>
        </footer>
